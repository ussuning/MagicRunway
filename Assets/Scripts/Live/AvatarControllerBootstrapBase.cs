...
public class AvatarControllerBootstrapBase : MonoBehaviour {
    ...
    public virtual void Init(int playerIndex = 0) {
        ...
        // TODO: move this into AvatarBootStrap
        /*
...
#if UNITY_EDITOR
[CustomEditor(typeof(AvatarControllerBootstrapBase))]
public class AvatarControllerBootstrapEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        AvatarControllerBootstrapBase myScript = (AvatarControllerBootstrapBase)target;
    ...
    void OnSceneGUI()
    {
        ...
        AvatarControllerBootstrapBase t = (AvatarControllerBootstrapBase)target;
